		...
		<nav class="container flex items-center justify-between py-6 ">
			...
			<div class="flex justify-end top ">
				<div class="flex items-center justify-end w-full">
					...
					<div class="flex items-center justify-end w-full transition duration-200 cursor-pointer lg:w-auto hover:text-red-500">
						<!-- log in -->
						...
						?>
						<?php  echo is_user_logged_in() ? '<a href="/logout" class="hidden text-lg md:flex">Se déconnecter</a>' : '<a href="/login" class="hidden text-lg md:flex">Se connecter</a>' ?>
					</div>	
				</div>

...
<div id="page" class="min-h-screen flex flex-col">
	...
	<div id="content" class="site-content flex-grow">
		...
		<div class="container mx-auto my-12 border-b pb-12">
			...
			<h2 class="text-3xl lg:text-7xl tracking-tight font-extrabold my-4">Fastly build your WordPress theme with <a href="https://tailwindcss.com" class="text-primary">TailwindCSS</a> and <a href="https://laravel-mix.com" class="text-primary">Laravel Mix</a>.</h2>
